...
from decouple import config, Csv #Izak
...
SECRET_KEY = config("SECRET_KEY") #Izak

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config("DEBUG", default=False, cast=bool)#Izak

ALLOWED_HOSTS = config("ALLOWED_HOSTS", cast=Csv())#Izak
